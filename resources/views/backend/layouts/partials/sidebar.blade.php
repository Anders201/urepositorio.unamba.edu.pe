                             ...
                             <ul
                                 ...
                                 @if ($usr->can('admin.view'))
                                     <li
                                         ...
                                         <a href="{{ route('admin.admins.index') }}">Usuarios</a>
                                     </li>
                                 @endif
                     ...
                     @if ($usr->can('dashboard.view') || $usr->can('dashboard.edit'))
                         <li>
                             <a href="javascript:void(0)" aria-expanded="true"><i class="fa fa-tasks"></i><span>
                                 ...
                                 <ul class="collapse">
                                    <li class="{{ Route::is('admin.tramites_pendientes') ? 'active' : '' }}"><a
                                        href="{{ route('admin.tramites_pendientes') }}">Tramites Pendientes</a></li>
                     ...
                     @if ($usr->can('dashboard.view') || $usr->can('dashboard.edit'))
                         <li>
                             <a href="javascript:void(0)" aria-expanded="true"><i class="fa fa-tasks"></i><span>
                                 ...
                                 <ul class="collapse">
                                    <li class="{{ Route::is('admin.generar_constancia') ? 'active' : '' }}"><a
                                        href="{{ route('admin.generar_constancia') }}">Generar Constancia</a></li>

                                    <li class="{{ Route::is('admin.constancias_realizadas') ? 'active' : '' }}"><a
                                        href="{{ route('admin.constancias_realizadas') }}">Constancias Realizadas</a></li>
                                </ul>
                         </li>
                     @endif
